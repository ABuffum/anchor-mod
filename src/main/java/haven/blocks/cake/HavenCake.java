...
public class HavenCake {
	private final Flavor flavor;
	public Flavor getFlavor() { return this.flavor; }
	public HavenPair getCake() { return flavor.getCake(); }
	...
	public HavenCake(Flavor flavor) { this(flavor, HavenMod.ItemSettings().maxCount(1)); }
	public HavenCake(Flavor flavor, Item.Settings settings) {
		this.flavor = flavor;
		flavor.cake = new HavenPair(new HavenCakeBlock(flavor), settings);
	...
	public static class Flavor {
		...
		protected HavenPair cake;
		public HavenPair getCake() { return this.cake; }
