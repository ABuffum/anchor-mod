...
public class SculkVeinBlock extends MultifaceGrowthBlock implements SculkSpreadable, Waterloggable {
	...
	@Override
	public void spreadAtSamePosition(World world, BlockState state, BlockPos pos, Random random) {
	...
	private boolean convertToBlock(SculkSpreadManager spreadManager, World world, BlockPos pos, Random random) {
		BlockState blockState = world.getBlockState(pos);
		Tag.Identified<Block> tagKey = spreadManager.getReplaceableTag();
