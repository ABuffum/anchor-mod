...
public class RoseFlowerBlock extends FlowerBlock {
	...
	public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
		...
		if (itemStack.isOf(Items.BONE_MEAL)) {
			if (world.getBlockState(pos.up()).isAir()) {
				world.setBlockState(pos, Blocks.ROSE_BUSH.getDefaultState(), Block.NOTIFY_ALL | Block.REDRAW_ON_MAIN_THREAD);
				world.setBlockState(pos.up(), Blocks.ROSE_BUSH.getDefaultState().with(TallPlantBlock.HALF, DoubleBlockHalf.UPPER), Block.NOTIFY_ALL);
