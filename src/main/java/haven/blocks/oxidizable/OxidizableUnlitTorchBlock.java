...
import haven.blocks.UnlitTorchBlock;
...
public class OxidizableUnlitTorchBlock extends UnlitTorchBlock implements Oxidizable {
	private final OxidizationLevel oxidizationLevel;

	public OxidizableUnlitTorchBlock(OxidizationLevel oxidizationLevel, Block lit) {
		super(lit);
