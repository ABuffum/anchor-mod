...
public class OxidizableWallBlock extends WallBlock implements Oxidizable {
	...
	public OxidizableWallBlock(Oxidizable.OxidizationLevel oxidizationLevel, Block block) {
		this(oxidizationLevel, Settings.copy(block));
	}
	public OxidizableWallBlock(Oxidizable.OxidizationLevel oxidizationLevel, Settings settings) {
		super(settings);
