...
public class PropaguleBlock extends PlantBlock implements Fertilizable, Waterloggable {
	...
	public boolean canPlaceAt(BlockState state, WorldView world, BlockPos pos) {
		if (PropaguleBlock.isHanging(state)) return world.getBlockState(pos.up()).isOf(ModBase.MANGROVE_MATERIAL.getLeaves().getBlock());
	...
	public static BlockState getHangingState(int age) {
		return ModBase.MANGROVE_MATERIAL.getPropagule().getBlock().getDefaultState().with(HANGING, true).with(AGE, age);
	}
}
