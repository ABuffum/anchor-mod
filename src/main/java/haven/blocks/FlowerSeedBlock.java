...
public class FlowerSeedBlock extends PlantBlock implements Fertilizable {
	...
	private static VoxelShape VOXEL_SHAPE = Block.createCuboidShape(0.0D, 0.0D, 0.0D, 16.0D, 2.0D, 16.0D);
	...
	public void grow(ServerWorld world, Random random, BlockPos pos, BlockState state) {
		...
		if (flower instanceof TallPlantBlock) {
			world.setBlockState(pos.up(), flower.getDefaultState().with(TallPlantBlock.HALF, DoubleBlockHalf.UPPER), Block.NOTIFY_ALL);
		}
	}
}
