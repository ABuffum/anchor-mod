...
public class WoodPowderSnowBucketItem extends Item implements FluidModificationItem {
	private final SoundEvent placeSound;

	private final Block block;
	public WoodPowderSnowBucketItem(Block block, SoundEvent placeSound, Settings settings) {
		super(settings);
	...
	public ItemStack getDefaultStack() {
		return new ItemStack(HavenMod.WOOD_POWDER_SNOW_BUCKET);
	}
