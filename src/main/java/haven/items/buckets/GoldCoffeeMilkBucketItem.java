...
public class GoldCoffeeMilkBucketItem extends WoodMilkBucketItem {

	public GoldCoffeeMilkBucketItem(Settings settings) {
		super(settings);
	}
	...
	public ItemStack finishUsing(ItemStack stack, World world, LivingEntity user) {
		...
		return stack.isEmpty() ? new ItemStack(HavenMod.GOLD_BUCKET) : stack;
	}
}