...
public class GoldPowderSnowBucketItem extends Item implements FluidModificationItem {
	private final SoundEvent placeSound;

	private final Block block;
	public GoldPowderSnowBucketItem(Block block, SoundEvent placeSound, Settings settings) {
		super(settings);
	...
	public ItemStack getDefaultStack() {
		return new ItemStack(HavenMod.GOLD_POWDER_SNOW_BUCKET);
	}
