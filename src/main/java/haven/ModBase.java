...
import haven.blocks.lighting.*;
import haven.blocks.plushie.*;
...
import haven.items.*;
import haven.items.basic.ModMusicDiscItem;
...
public class ModBase implements ModInitializer {
	...
	public static final ToIntFunction<BlockState> LUMINANCE_15 = state -> 15;
	public static final ToIntFunction<BlockState> LUMINANCE_14 = state -> 14;
	public static final ToIntFunction<BlockState> LUMINANCE_13 = state -> 13;
	public static final ToIntFunction<BlockState> LUMINANCE_12 = state -> 12;
	public static final ToIntFunction<BlockState> LUMINANCE_11 = state -> 11;
	public static final ToIntFunction<BlockState> LUMINANCE_10 = state -> 10;
	public static final ToIntFunction<BlockState> LUMINANCE_9 = state -> 9;
	public static final ToIntFunction<BlockState> LUMINANCE_8 = state -> 8;
	public static final ToIntFunction<BlockState> LUMINANCE_7 = state -> 7;
	public static final ToIntFunction<BlockState> LUMINANCE_6 = state -> 6;
	public static final ToIntFunction<BlockState> LUMINANCE_5 = state -> 5;
	public static final ToIntFunction<BlockState> LUMINANCE_4 = state -> 4;
	public static final ToIntFunction<BlockState> LUMINANCE_3 = state -> 3;
	public static final ToIntFunction<BlockState> LUMINANCE_2 = state -> 2;
	public static final ToIntFunction<BlockState> LUMINANCE_1 = state -> 1;
	public static final ToIntFunction<BlockState> LUMINANCE_0 = state -> 0;
	...
	public static final TorchContainer UNDERWATER_TORCH = TorchContainer.Waterloggable(Block.Settings.of(Material.DECORATION).noCollision().breakInstantly().luminance(LUMINANCE_14).sounds(BlockSoundGroup.WOOD), UNDERWATER_TORCH_GLOW);
	...
	public static final BlockContainer BLEEDING_OBSIDIAN = new BlockContainer(new BleedingObsidianBlock(Block.Settings.copy(Blocks.CRYING_OBSIDIAN)));
	...
	public static final BlockContainer CARVED_MELON = new BlockContainer(new CarvedMelonBlock(Block.Settings.of(Material.GOURD, MapColor.LIME).strength(1.0F).sounds(BlockSoundGroup.WOOD).allowsSpawning(BaseMaterial::always)));
	public static final BlockContainer MELON_LANTERN = new BlockContainer(new CarvedMelonBlock(Block.Settings.of(Material.GOURD, MapColor.LIME).strength(1.0F).sounds(BlockSoundGroup.WOOD).luminance(LUMINANCE_15).allowsSpawning(BaseMaterial::always)));
	public static final BlockContainer SOUL_MELON_LANTERN = new BlockContainer(new CarvedMelonBlock(Block.Settings.of(Material.GOURD, MapColor.LIME).strength(1.0F).sounds(BlockSoundGroup.WOOD).luminance(LUMINANCE_10).allowsSpawning(BaseMaterial::always)));
	public static final BlockContainer ENDER_MELON_LANTERN = new BlockContainer(new CarvedMelonBlock(Block.Settings.of(Material.GOURD, MapColor.LIME).strength(1.0F).sounds(BlockSoundGroup.WOOD).luminance(LUMINANCE_13).allowsSpawning(BaseMaterial::always)));
	...
	public static final BlockContainer WHITE_JACK_O_LANTERN = new BlockContainer(new CarvedWhitePumpkinBlock(Block.Settings.of(Material.GOURD, MapColor.WHITE).strength(1.0F).sounds(BlockSoundGroup.WOOD).luminance(LUMINANCE_15).allowsSpawning(BaseMaterial::always)));
	public static final BlockContainer WHITE_SOUL_JACK_O_LANTERN = new BlockContainer(new CarvedWhitePumpkinBlock(Block.Settings.of(Material.GOURD, MapColor.WHITE).strength(1.0F).sounds(BlockSoundGroup.WOOD).luminance(LUMINANCE_10).allowsSpawning(BaseMaterial::always)));
	public static final BlockContainer WHITE_ENDER_JACK_O_LANTERN = new BlockContainer(new CarvedWhitePumpkinBlock(Block.Settings.of(Material.GOURD, MapColor.WHITE).strength(1.0F).sounds(BlockSoundGroup.WOOD).luminance(LUMINANCE_13).allowsSpawning(BaseMaterial::always)));
	public static final CarvedGourdContainer WHITE_PUMPKIN = new CarvedGourdContainer(
			new CarvedWhitePumpkinBlock(Block.Settings.of(Material.GOURD, MapColor.WHITE).strength(1.0F).sounds(BlockSoundGroup.WOOD).allowsSpawning(BaseMaterial::always)),
			new CarvedWhitePumpkinBlock(Block.Settings.of(Material.GOURD, MapColor.WHITE).strength(1.0F).sounds(BlockSoundGroup.WOOD).luminance(LUMINANCE_10).allowsSpawning(BaseMaterial::always)),
			...
			Block.Settings.copy(Blocks.ATTACHED_PUMPKIN_STEM), ItemSettings());
	//Rotten Pumpkin
	public static final BlockContainer CARVED_ROTTEN_PUMPKIN = new BlockContainer(new CarvedGourdBlock(Block.Settings.of(Material.GOURD, MapColor.PALE_YELLOW).strength(1.0F).sounds(BlockSoundGroup.WOOD).allowsSpawning(BaseMaterial::always)));
	public static final BlockContainer ROTTEN_JACK_O_LANTERN = new BlockContainer(new CarvedGourdBlock(Block.Settings.of(Material.GOURD, MapColor.PALE_YELLOW).strength(1.0F).sounds(BlockSoundGroup.WOOD).luminance(LUMINANCE_15).allowsSpawning(BaseMaterial::always)));
	public static final BlockContainer ROTTEN_SOUL_JACK_O_LANTERN = new BlockContainer(new CarvedGourdBlock(Block.Settings.of(Material.GOURD, MapColor.PALE_YELLOW).strength(1.0F).sounds(BlockSoundGroup.WOOD).luminance(LUMINANCE_10).allowsSpawning(BaseMaterial::always)));
	public static final BlockContainer ROTTEN_ENDER_JACK_O_LANTERN = new BlockContainer(new CarvedGourdBlock(Block.Settings.of(Material.GOURD, MapColor.PALE_YELLOW).strength(1.0F).sounds(BlockSoundGroup.WOOD).luminance(LUMINANCE_13).allowsSpawning(BaseMaterial::always)));
	...
	//Mossy Sheep
	public static final BedContainer MOSS_BED = new BedContainer("moss");
	public static final EntityType<MossySheepEntity> MOSSY_SHEEP_ENTITY = FabricEntityTypeBuilder.create(SpawnGroup.CREATURE, MossySheepEntity::new).dimensions(EntityType.SHEEP.getDimensions()).trackRangeBlocks(10).build();
	public static final Item MOSSY_SHEEP_SPAWN_EGG = new SpawnEggItem(MOSSY_SHEEP_ENTITY, 16777215, 16777215, ItemSettings());

	//Flowers
	private static Item getHydrangeaItem() { return HYDRANGEA.getItem(); }
	public static final ItemGroup FLOWER_GROUP = FabricItemGroupBuilder.build(ModBase.ID("flowers"), () -> new ItemStack(ModBase::getHydrangeaItem));
	...
	private static TallFlowerBlock getBlueRoseBush() { return (TallFlowerBlock) BLUE_ROSE_BUSH.getBlock(); }
	...
	private static TallFlowerBlock getTallPinkAlliumBlock() { return (TallFlowerBlock) TALL_PINK_ALLIUM.getBlock(); }
	...
	public static final FlowerSeedContainer AMARANTH_SEEDS = new FlowerSeedContainer((TallFlowerBlock) AMARANTH.getBlock());
	public static final TallBlockContainer BLUE_ROSE_BUSH = new TallBlockContainer(new CuttableFlowerBlock(FlowerContainer.TallSettings(), () -> (FlowerBlock) BLUE_ROSE.getBlock(), null), ItemSettings().group(FLOWER_GROUP));
	...
	public static final TallBlockContainer TALL_PINK_ALLIUM = new TallBlockContainer(new CuttableFlowerBlock(FlowerContainer.TallSettings(), () -> (FlowerBlock) PINK_ALLIUM.getBlock(), null), ItemSettings().group(FLOWER_GROUP));
	...
	//Plushies
	private static Item getFancyChickenPlushieItem() { return FANCY_CHICKEN_PLUSHIE.getItem(); }
	...
	public static final BlockContainer AMBER_CHICKEN_PLUSHIE = MakePlushie(ChickenPlushie::new);
	public static final BlockContainer BRONZED_CHICKEN_PLUSHIE = MakePlushie(ChickenPlushie::new);
	public static final BlockContainer GOLD_CRESTED_CHICKEN_PLUSHIE = MakePlushie(ChickenPlushie::new);
	public static final BlockContainer MIDNIGHT_CHICKEN_PLUSHIE = MakePlushie(ChickenPlushie::new);
	public static final BlockContainer SKEWBALD_CHICKEN_PLUSHIE = MakePlushie(ChickenPlushie::new);
	public static final BlockContainer STORMY_CHICKEN_PLUSHIE = MakePlushie(ChickenPlushie::new);
	//Pigs
	public static final BlockContainer PIG_PLUSHIE = MakePlushie(PigPlushie::new);
	public static final BlockContainer SADDLED_PIG_PLUSHIE = MakePlushie(PigPlushie::new);
	public static final BlockContainer MOTTLED_PIG_PLUSHIE = MakePlushie(PigPlushie::new);
	public static final BlockContainer MUDDY_PIG_PLUSHIE = MakePlushie(PigPlushie::new);
	public static final BlockContainer DRIED_MUDDY_PIG_PLUSHIE = MakePlushie(PigPlushie::new);
	public static final BlockContainer PALE_PIG_PLUSHIE = MakePlushie(PigPlushie::new);
	public static final BlockContainer PIEBALD_PIG_PLUSHIE = MakePlushie(PigPlushie::new);
	public static final BlockContainer PINK_FOOTED_PIG_PLUSHIE = MakePlushie(PigPlushie::new);
	public static final BlockContainer SOOTY_PIG_PLUSHIE = MakePlushie(PigPlushie::new);
	public static final BlockContainer SPOTTED_PIG_PLUSHIE = MakePlushie(PigPlushie::new);
	//Sheep
	public static final BlockContainer SHEARED_SHEEP_PLUSHIE = MakePlushie(SheepPlushie::new);
	public static final BlockContainer FLECKED_SHEEP_PLUSHIE = MakePlushie(SheepPlushie::new);
	public static final BlockContainer SHEARED_FLECKED_SHEEP_PLUSHIE = MakePlushie(SheepPlushie::new);
	public static final BlockContainer FUZZY_SHEEP_PLUSHIE = MakePlushie(SheepPlushie::new);
	public static final BlockContainer SHEARED_FUZZY_SHEEP_PLUSHIE = MakePlushie(SheepPlushie::new);
	public static final BlockContainer INKY_SHEEP_PLUSHIE = MakePlushie(SheepPlushie::new);
	public static final BlockContainer SHEARED_INKY_SHEEP_PLUSHIE = MakePlushie(SheepPlushie::new);
	public static final BlockContainer LONG_NOSE_SHEEP_PLUSHIE = MakePlushie(SheepPlushie::new);
	public static final BlockContainer SHEARED_LONG_NOSE_SHEEP_PLUSHIE = MakePlushie(SheepPlushie::new);
	public static final BlockContainer PATCHED_SHEEP_PLUSHIE = MakePlushie(SheepPlushie::new);
	public static final BlockContainer SHEARED_PATCHED_SHEEP_PLUSHIE = MakePlushie(SheepPlushie::new);
	public static final BlockContainer ROCKY_SHEEP_PLUSHIE = MakePlushie(SheepPlushie::new);
	public static final BlockContainer SHEARED_ROCKY_SHEEP_PLUSHIE = MakePlushie(SheepPlushie::new);
	public static final BlockContainer RAINBOW_SHEEP_PLUSHIE = MakePlushie(SheepPlushie::new);
	public static final BlockContainer SHEARED_RAINBOW_SHEEP_PLUSHIE = MakePlushie(SheepPlushie::new);
	public static final BlockContainer MOSSY_SHEEP_PLUSHIE = MakePlushie(SheepPlushie::new);
	public static final BlockContainer SHEARED_MOSSY_SHEEP_PLUSHIE = MakePlushie(SheepPlushie::new);
	//Cows
	public static final BlockContainer ALBINO_COW_PLUSHIE = MakePlushie(CowPlushie::new);
	public static final BlockContainer ASHEN_COW_PLUSHIE = MakePlushie(CowPlushie::new);
	public static final BlockContainer COOKIE_COW_PLUSHIE = MakePlushie(CowPlushie::new);
	public static final BlockContainer CREAM_COW_PLUSHIE = MakePlushie(CowPlushie::new);
	public static final BlockContainer DAIRY_COW_PLUSHIE = MakePlushie(CowPlushie::new);
	public static final BlockContainer PINTO_COW_PLUSHIE = MakePlushie(CowPlushie::new);
	public static final BlockContainer SUNSET_COW_PLUSHIE = MakePlushie(CowPlushie::new);
	public static final BlockContainer UMBRA_COW_PLUSHIE = MakePlushie(CowPlushie::new);
	public static final BlockContainer SHEARED_UMBRA_COW_PLUSHIE = MakePlushie(CowPlushie::new);
	public static final BlockContainer WOOLY_COW_PLUSHIE = MakePlushie(CowPlushie::new);
	public static final BlockContainer SHEARED_WOOLY_COW_PLUSHIE = MakePlushie(CowPlushie::new);
	public static final BlockContainer MOOSHROOM_PLUSHIE_BLUE = MakePlushie(CowPlushie::new);
	public static final BlockContainer MOOSHROOM_PLUSHIE_CRIMSON = MakePlushie(CowPlushie::new);
	public static final BlockContainer MOOSHROOM_PLUSHIE_GILDED = MakePlushie(CowPlushie::new);
	public static final BlockContainer MOOSHROOM_PLUSHIE_WARPED = MakePlushie(CowPlushie::new);
	public static final BlockContainer MOOBLOOM_PLUSHIE = MakePlushie(CowPlushie::new);
	public static final BlockContainer MOOLIP_PLUSHIE = MakePlushie(CowPlushie::new);
	public static final BlockContainer MOOBLOSSOM_PLUSHIE = MakePlushie(CowPlushie::new);
	public static final BlockContainer MOOBLOSSOM_PLUSHIE_ORANGE = MakePlushie(CowPlushie::new);
	public static final BlockContainer MOOBLOSSOM_PLUSHIE_PINK = MakePlushie(CowPlushie::new);
	public static final BlockContainer MOOBLOSSOM_PLUSHIE_RED = MakePlushie(CowPlushie::new);
	public static final BlockContainer MOOBLOSSOM_PLUSHIE_WHITE = MakePlushie(CowPlushie::new);
	public static final BlockContainer COWCOA_PLUSHIE = MakePlushie(CowPlushie::new);
	public static final BlockContainer COWFEE_PLUSHIE = MakePlushie(CowPlushie::new);
	public static final BlockContainer STRAWBOVINE_PLUSHIE = MakePlushie(CowPlushie::new);
	public static final BlockContainer MOONILLA_PLUSHIE = MakePlushie(CowPlushie::new);
	//Golems
	public static final BlockContainer WHITE_SNOW_GOLEM_PLUSHIE = MakePlushie(SnowGolemPlushie::new);
	public static final BlockContainer ROTTEN_SNOW_GOLEM_PLUSHIE = MakePlushie(SnowGolemPlushie::new);
	public static final BlockContainer SHEARED_SNOW_GOLEM_PLUSHIE = MakePlushie(SnowGolemPlushie::new);
	public static final BlockContainer MELON_GOLEM_PLUSHIE = MakePlushie(SnowGolemPlushie::new);
	public static final BlockContainer SHEARED_MELON_GOLEM_PLUSHIE = MakePlushie(SnowGolemPlushie::new);
	//Axolotls
	public static final BlockContainer BLACK_AXOLOTL_PLUSHIE = MakePlushie(AxolotlPlushie::new);
	public static final BlockContainer CYANIDE_AXOLOTL_PLUSHIE = MakePlushie(AxolotlPlushie::new);
	public static final BlockContainer GLOW_AXOLOTL_PLUSHIE = MakePlushie(AxolotlPlushie::new);
	public static final BlockContainer GOLDEN_AXOLOTL_PLUSHIE = MakePlushie(AxolotlPlushie::new);
	public static final BlockContainer GREEN_AXOLOTL_PLUSHIE = MakePlushie(AxolotlPlushie::new);
	public static final BlockContainer LUCIA_AXOLOTL_PLUSHIE = MakePlushie(AxolotlPlushie::new);
	public static final BlockContainer RED_AXOLOTL_PLUSHIE = MakePlushie(AxolotlPlushie::new);
	public static final BlockContainer SCULK_AXOLOTL_PLUSHIE = MakePlushie(AxolotlPlushie::new);
	public static final BlockContainer WHITE_AXOLOTL_PLUSHIE = MakePlushie(AxolotlPlushie::new);
	public static final BlockContainer WILDER_AXOLOTL_PLUSHIE = MakePlushie(AxolotlPlushie::new);

	//Decoration Blocks
	private static Item getDecorativeVineItem() { return DECORATIVE_VINE.getItem(); }
	public static final ItemGroup DECORATION_GROUP = FabricItemGroupBuilder.build(ModBase.ID("decorative_blocks"), () -> new ItemStack(ModBase::getDecorativeVineItem));
	...
	public static final BlockContainer SOLEIL_SOUL_JACK_O_LANTERN = new BlockContainer(new CarvedMelonBlock(Block.Settings.copy(SOUL_JACK_O_LANTERN.getBlock())));
	public static final BlockContainer SOLEIL_ENDER_JACK_O_LANTERN = new BlockContainer(new CarvedMelonBlock(Block.Settings.copy(ENDER_JACK_O_LANTERN.getBlock())));
	public static final BlockContainer SOLEIL_CARVED_MELON = new BlockContainer(new CarvedMelonBlock(Block.Settings.copy(CARVED_MELON.getBlock())));
	public static final BlockContainer SOLEIL_MELON_LANTERN = new BlockContainer(new CarvedMelonBlock(Block.Settings.copy(MELON_LANTERN.getBlock())));
	public static final BlockContainer SOLEIL_SOUL_MELON_LANTERN = new BlockContainer(new CarvedMelonBlock(Block.Settings.copy(SOUL_MELON_LANTERN.getBlock())));
	public static final BlockContainer SOLEIL_ENDER_MELON_LANTERN = new BlockContainer(new CarvedMelonBlock(Block.Settings.copy(ENDER_MELON_LANTERN.getBlock())));
	public static final BlockContainer SOLEIL_CARVED_WHITE_PUMPKIN = new BlockContainer(new CarvedMelonBlock(Block.Settings.copy(WHITE_PUMPKIN.getCarved().getBlock())));
	public static final BlockContainer SOLEIL_WHITE_JACK_O_LANTERN = new BlockContainer(new CarvedMelonBlock(Block.Settings.copy(WHITE_JACK_O_LANTERN.getBlock())));
	public static final BlockContainer SOLEIL_WHITE_SOUL_JACK_O_LANTERN = new BlockContainer(new CarvedMelonBlock(Block.Settings.copy(WHITE_SOUL_JACK_O_LANTERN.getBlock())));
	public static final BlockContainer SOLEIL_WHITE_ENDER_JACK_O_LANTERN = new BlockContainer(new CarvedMelonBlock(Block.Settings.copy(WHITE_ENDER_JACK_O_LANTERN.getBlock())));
	public static final BlockContainer SOLEIL_CARVED_ROTTEN_PUMPKIN = new BlockContainer(new CarvedMelonBlock(Block.Settings.copy(CARVED_ROTTEN_PUMPKIN.getBlock())));
	public static final BlockContainer SOLEIL_ROTTEN_JACK_O_LANTERN = new BlockContainer(new CarvedMelonBlock(Block.Settings.copy(ROTTEN_JACK_O_LANTERN.getBlock())));
	public static final BlockContainer SOLEIL_ROTTEN_SOUL_JACK_O_LANTERN = new BlockContainer(new CarvedMelonBlock(Block.Settings.copy(ROTTEN_SOUL_JACK_O_LANTERN.getBlock())));
	public static final BlockContainer SOLEIL_ROTTEN_ENDER_JACK_O_LANTERN = new BlockContainer(new CarvedMelonBlock(Block.Settings.copy(ROTTEN_ENDER_JACK_O_LANTERN.getBlock())));

	public static final Block COFFEE_PLANT = new CoffeePlantBlock(Block.Settings.of(Material.PLANT).ticksRandomly().noCollision().sounds(BlockSoundGroup.CROP));
	...
	private static TallFlowerBlock getTallVanillaBlock() { return (TallFlowerBlock) TALL_VANILLA.getBlock(); }
	public static final FlowerContainer VANILLA_FLOWER = new FlowerContainer(new GrowableFlowerBlock(StatusEffects.INSTANT_HEALTH, 11, FlowerContainer.Settings(), ModBase::getTallVanillaBlock));
	public static final TallBlockContainer TALL_VANILLA = new TallBlockContainer(new CuttableFlowerBlock(FlowerContainer.TallSettings(), () -> (FlowerBlock) VANILLA_FLOWER.getBlock(), (world) -> new ItemStack(ModBase.VANILLA, world.random.nextInt(2) + 1)), FlowerContainer.PetalSettings());
	...
	public static final BlockContainer PALE_CHERRY_LEAVES = new BlockContainer(new HavenLeavesBlock(CHERRY_MATERIAL.getLeaves().getBlock()));
	public static final Item PALE_CHERRY_PETALS = new Item(FlowerContainer.PetalSettings());
	public static final BlockContainer PINK_CHERRY_LEAVES = new BlockContainer(new HavenLeavesBlock(CHERRY_MATERIAL.getLeaves().getBlock()));
	public static final Item PINK_CHERRY_PETALS = new Item(FlowerContainer.PetalSettings());
	public static final BlockContainer WHITE_CHERRY_LEAVES = new BlockContainer(new HavenLeavesBlock(CHERRY_MATERIAL.getLeaves().getBlock()));
	...
	private static ConfiguredFeature<TreeFeatureConfig, ?> CherryTreeFeature(Block leaves) {
		return Feature.TREE.configure(
				new TreeFeatureConfig.Builder(
						new SimpleBlockStateProvider(CHERRY_MATERIAL.getLog().getBlock().getDefaultState()),
						new ForkingTrunkPlacer(5, 2, 2),
						new SimpleBlockStateProvider(leaves.getDefaultState()),
						new SimpleBlockStateProvider(CHERRY_MATERIAL.getSapling().getBlock().getDefaultState()),
						new AcaciaFoliagePlacer(ConstantIntProvider.create(2), ConstantIntProvider.create(0)),
						new TwoLayersFeatureSize(1, 0, 2)
				).ignoreVines().build()
		);
	}
	public static final ConfiguredFeature<TreeFeatureConfig, ?> CHERRY_TREE = CherryTreeFeature(CHERRY_MATERIAL.getLeaves().getBlock());
	public static final ConfiguredFeature<TreeFeatureConfig, ?> PALE_CHERRY_TREE = CherryTreeFeature(PALE_CHERRY_LEAVES.getBlock());
	public static final ConfiguredFeature<TreeFeatureConfig, ?> PINK_CHERRY_TREE = CherryTreeFeature(PINK_CHERRY_LEAVES.getBlock());
	public static final ConfiguredFeature<TreeFeatureConfig, ?> WHITE_CHERRY_TREE = CherryTreeFeature(WHITE_CHERRY_LEAVES.getBlock());
	...
	public static final BlockContainer FLOWERING_CASSIA_LEAVES = new BlockContainer(new HavenLeavesBlock(CASSIA_MATERIAL.getLeaves().getBlock()));
	...
	public static final ConfiguredFeature<TreeFeatureConfig, ?> CASSIA_TREE = Feature.TREE.configure(
			new TreeFeatureConfig.Builder(
					new SimpleBlockStateProvider(CASSIA_MATERIAL.getLog().getBlock().getDefaultState()),
					new BendingTrunkPlacer(4, 2, 0, 3, UniformIntProvider.create(1, 2)),
					new WeightedBlockStateProvider(
							new DataPool.Builder()
									.add(CASSIA_MATERIAL.getLeaves().getBlock().getDefaultState(), 3)
									.add(FLOWERING_CASSIA_LEAVES.getBlock().getDefaultState(), 1)
					),
					new SimpleBlockStateProvider(CASSIA_MATERIAL.getSapling().getBlock().getDefaultState()),
	...
	//Grapes
	public static final Item GRAPES = new Item(ItemSettings().food(new FoodComponent.Builder().hunger(2).saturationModifier(0.1F).build()));
	//Drinks & Juice
	...
	public static final BlockContainer JUICER = new BlockContainer(new JuicerBlock(Block.Settings.of(Material.STONE).requiresTool().strength(3.5F)), ItemSettings());
	...
	public static final Item GRAPE_JUICE = new BottledDrinkItem(BottledDrinkSettings());
	...
	public static final Item GRAPE_SMOOTHIE = new BottledDrinkItem(SmoothieSettings());
	...
	public static final BlockContainer DRIED_BAMBOO_BLOCK = new BlockContainer(new DriedBambooBlock(Block.Settings.copy(Blocks.BAMBOO)));
	public static final Block POTTED_DRIED_BAMBOO = new FlowerPotBlock(DRIED_BAMBOO_BLOCK.getBlock(), Block.Settings.of(Material.DECORATION).breakInstantly().nonOpaque());
	...
	//Charred Wood
	public static final BaseTreeMaterial CHARRED_MATERIAL = new BaseTreeMaterial("charred", MapColor.BLACK, false, BlockSoundGroup.WOOD);
	...
	public static final BlockPileFeatureConfig GILDED_ROOTS_CONFIG = new BlockPileFeatureConfig(
		new WeightedBlockStateProvider(DataPool.<BlockState>builder()
			...
			.add(GILDED_MATERIAL.getFungus().getBlock().getDefaultState(), 11)
			.add(Blocks.CRIMSON_FUNGUS.getDefaultState(), 1)
			.add(Blocks.WARPED_FUNGUS.getDefaultState(), 1)
		)
	);
	public static final BlockContainer GILDED_NYLIUM = new BlockContainer(new HavenNyliumBlock(Block.Settings.of(Material.STONE, MapColor.GOLD).requiresTool().strength(0.4F).sounds(BlockSoundGroup.NYLIUM).ticksRandomly()));

	//Misc Mushroom Stuff
	public static final BlockContainer BLUE_SHROOMLIGHT = new BlockContainer(new Block(Block.Settings.of(Material.SOLID_ORGANIC, MapColor.CYAN).strength(1.0f).sounds(BlockSoundGroup.SHROOMLIGHT).luminance(LUMINANCE_15)));

	//Misc Removed
	public static final BlockContainer WAX_BLOCK = new BlockContainer(new Block(Block.Settings.copy(Blocks.HONEYCOMB_BLOCK)));
	...
	//Music Discs
	public static final Item MUSIC_DISC_OTHERSIDE = new ModMusicDiscItem(14, ModSoundEvents.MUSIC_DISC_OTHERSIDE, ItemSettings().maxCount(1).rarity(Rarity.RARE));
	public static final Item MUSIC_DISC_5 = new ModMusicDiscItem(15, ModSoundEvents.MUSIC_DISC_5, ItemSettings().maxCount(1).rarity(Rarity.RARE));
	...
	public static final BlockContainer MUDDY_MANGROVE_ROOTS = new BlockContainer(new PillarBlock(Block.Settings.of(Material.SOIL, MapColor.SPRUCE_BROWN).strength(0.7f).sounds(ModBlockSoundGroups.MUDDY_MANGROVE_ROOTS)));
	...
	public static final ConfiguredFeature<MangroveTreeFeatureConfig, ?> MANGROVE_FEATURE = MANGROVE_TREE_FEATURE.configure(
			new MangroveTreeFeatureConfig(false));
	public static final ConfiguredFeature<MangroveTreeFeatureConfig, ?> TALL_MANGROVE_FEATURE = MANGROVE_TREE_FEATURE.configure(
			new MangroveTreeFeatureConfig(true));

	public static final TorchContainer MANGROVE_TORCH = BaseMaterial.MakeTorch(LUMINANCE_14, BlockSoundGroup.WOOD, ParticleTypes.FLAME, ItemSettings());
	public static final TorchContainer MANGROVE_ENDER_TORCH = BaseMaterial.MakeTorch(LUMINANCE_12, BlockSoundGroup.WOOD, ModBase.ENDER_FIRE_FLAME_PARTICLE, ItemSettings());
	public static final TorchContainer MANGROVE_SOUL_TORCH = BaseMaterial.MakeTorch(LUMINANCE_10, BlockSoundGroup.WOOD, ParticleTypes.SOUL_FIRE_FLAME, ItemSettings());
	public static final BlockContainer MANGROVE_CAMPFIRE = BaseMaterial.MakeCampfire(15, 1, MapColor.RED, BlockSoundGroup.WOOD, true, ItemSettings());
	...
	public static final BlockContainer OCHRE_FROGLIGHT = new BlockContainer(new PillarBlock(Block.Settings.of(FROGLIGHT_MATERIAL, MapColor.PALE_YELLOW).strength(0.3f).luminance(LUMINANCE_15).sounds(ModBlockSoundGroups.FROGLIGHT)));
	public static final BlockContainer VERDANT_FROGLIGHT = new BlockContainer(new PillarBlock(Block.Settings.of(FROGLIGHT_MATERIAL, MapColor.LICHEN_GREEN).strength(0.3f).luminance(LUMINANCE_15).sounds(ModBlockSoundGroups.FROGLIGHT)));
	public static final BlockContainer PEARLESCENT_FROGLIGHT = new BlockContainer(new PillarBlock(Block.Settings.of(FROGLIGHT_MATERIAL, MapColor.PINK).strength(0.3f).luminance(LUMINANCE_15).sounds(ModBlockSoundGroups.FROGLIGHT)));
	//Deep Dark
	public static final BlockContainer REINFORCED_DEEPSLATE = new BlockContainer(new Block(Block.Settings.of(Material.STONE, MapColor.DEEPSLATE_GRAY).sounds(BlockSoundGroup.DEEPSLATE).strength(55.0f, 1200.0f)));
	...
	public static final BlockContainer BUDDING_ECHO = new BlockContainer(new BuddingEchoBlock(Block.Settings.copy(ECHO_MATERIAL.getBlock().getBlock()).ticksRandomly()));
	public static final BlockContainer ECHO_CLUSTER = new BlockContainer(new EchoClusterBlock(7, 3, Block.Settings.of(Material.SCULK).nonOpaque().ticksRandomly().sounds(BlockSoundGroup.AMETHYST_CLUSTER).strength(1.5F).luminance(LUMINANCE_3)));
	public static final BlockContainer LARGE_ECHO_BUD = new BlockContainer(new EchoClusterBlock(5, 3, Block.Settings.copy(ECHO_CLUSTER.getBlock()).sounds(BlockSoundGroup.MEDIUM_AMETHYST_BUD).luminance(LUMINANCE_2)));
	public static final BlockContainer MEDIUM_ECHO_BUD = new BlockContainer(new EchoClusterBlock(4, 3, Block.Settings.copy(ECHO_CLUSTER.getBlock()).sounds(BlockSoundGroup.LARGE_AMETHYST_BUD).luminance(LUMINANCE_1)));
	public static final BlockContainer SMALL_ECHO_BUD = new BlockContainer(new EchoClusterBlock(3, 4, Block.Settings.copy(ECHO_CLUSTER.getBlock()).sounds(BlockSoundGroup.SMALL_AMETHYST_BUD)));
	//Sculk
	public static final BlockContainer SCULK_SENSOR = new BlockContainer(new HavenSculkSensorBlock(Block.Settings.of(Material.SCULK, MapColor.CYAN).strength(1.5f).sounds(BlockSoundGroup.SCULK_SENSOR).luminance(state -> 1).emissiveLighting((state, world, pos) -> HavenSculkSensorBlock.getPhase(state) == SculkSensorPhase.ACTIVE), 8));
	public static final BlockEntityType<HavenSculkSensorBlockEntity> SCULK_SENSOR_ENTITY = FabricBlockEntityTypeBuilder.create(HavenSculkSensorBlockEntity::new, SCULK_SENSOR.getBlock()).build();
	public static final BlockContainer SCULK = new BlockContainer(new SculkBlock(Block.Settings.of(Material.SCULK).strength(0.2f).sounds(ModBlockSoundGroups.SCULK)));
	public static final SculkStoneMaterial SCULK_STONE_MATERIAL = new SculkStoneMaterial();
	public static final BlockContainer CALCITE_SCULK_TURF = new BlockContainer(new SculkTurfBlock(Blocks.CALCITE, Block.Settings.of(Material.STONE, MapColor.BLACK).requiresTool().strength(0.75F).sounds(ModBlockSoundGroups.SCULK).ticksRandomly()));
	public static final BlockContainer DEEPSLATE_SCULK_TURF = new BlockContainer(new SculkTurfBlock(Blocks.DEEPSLATE, Block.Settings.of(Material.STONE, MapColor.BLACK).requiresTool().strength(3.0F, 6.0F).sounds(ModBlockSoundGroups.SCULK).ticksRandomly()));
	public static final BlockContainer DRIPSTONE_SCULK_TURF = new BlockContainer(new SculkTurfBlock(Blocks.DRIPSTONE_BLOCK, Block.Settings.of(Material.STONE, MapColor.BLACK).requiresTool().strength(1.5F, 1.0F).sounds(ModBlockSoundGroups.SCULK).ticksRandomly()));
	public static final BlockContainer SMOOTH_BASALT_SCULK_TURF = new BlockContainer(new SculkTurfBlock(Blocks.SMOOTH_BASALT, Block.Settings.of(Material.STONE, MapColor.BLACK).requiresTool().strength(1.25F, 4.2F).sounds(ModBlockSoundGroups.SCULK).ticksRandomly()));
	...
	public static final BlockContainer SCULK_CATALYST = new BlockContainer(new SculkCatalystBlock(Block.Settings.of(Material.SCULK).strength(3.0f, 3.0f).sounds(ModBlockSoundGroups.SCULK_CATALYST).luminance(state -> 6)));
	public static final BlockEntityType<SculkCatalystBlockEntity> SCULK_CATALYST_ENTITY = FabricBlockEntityTypeBuilder.create(SculkCatalystBlockEntity::new, SCULK_CATALYST.getBlock()).build();
	public static final BlockContainer SCULK_SHRIEKER = new BlockContainer(new SculkShriekerBlock(Block.Settings.of(Material.SCULK, MapColor.BLACK).strength(3.0f, 3.0f).sounds(ModBlockSoundGroups.SCULK_SHRIEKER)));
	public static final BlockEntityType<SculkShriekerBlockEntity> SCULK_SHRIEKER_ENTITY = FabricBlockEntityTypeBuilder.create(SculkShriekerBlockEntity::new, SCULK_SHRIEKER.getBlock()).build();
	//Deep Dark
	...
	public static final Item WARDEN_SPAWN_EGG = new SpawnEggItem(WARDEN_ENTITY, 1001033, 3790560, ItemSettings());
	...
	public static final BlockContainer SUGAR_BLOCK = new BlockContainer(new SugarBlock(Block.Settings.of(Material.AGGREGATE, MapColor.WHITE).strength(0.6F).sounds(BlockSoundGroup.SAND)));
	public static final BlockContainer CARAMEL_BLOCK = new BlockContainer(new Block(Block.Settings.of(Material.STONE, MapColor.ORANGE).strength(0.8F).sounds(ModBlockSoundGroups.MUD)));
	public static final BlockContainer COCOA_BLOCK = new BlockContainer(new Block(Block.Settings.of(Material.SOLID_ORGANIC, MapColor.BROWN).strength(0.8F).sounds(BlockSoundGroup.WOOD)));

	public static final BlockContainer SEED_BLOCK = new BlockContainer(new Block(Block.Settings.of(Material.SOLID_ORGANIC, MapColor.DARK_GREEN).strength(0.8F).sounds(BlockSoundGroup.GRASS)));
	...
	public static final Item CONFETTI_SYRINGE = new BaseSyringeItem((PlayerEntity user, LivingEntity entity) -> {
		...
		public ActionResult useOnBlock(ItemUsageContext context) {
			...
			if (block == Blocks.PUMPKIN) {
				outBlock = ModBase.SOLEIL_CARVED_PUMPKIN.getBlock();
				outItem = Items.PUMPKIN_SEEDS;
			}
			else if (block == Blocks.MELON) {
				outBlock = ModBase.SOLEIL_CARVED_MELON.getBlock();
				outItem = Items.MELON_SEEDS;
			}
			else if (block == ModBase.WHITE_PUMPKIN.getGourd().getBlock()) {
				outBlock = ModBase.SOLEIL_CARVED_WHITE_PUMPKIN.getBlock();
				outItem = ModBase.WHITE_PUMPKIN.getSeeds();
			}
			else if (block == ModBase.ROTTEN_PUMPKIN.getBlock()) {
				outBlock = ModBase.SOLEIL_CARVED_ROTTEN_PUMPKIN.getBlock();
			...
			if (!world.isClient) {
				...
				world.playSound(null, pos, ModSoundEvents.SYRINGE_INJECTED, SoundCategory.BLOCKS, 1.0F, 1.0F);
	...
	public static final Block COTTAGE_CHEESE_BLOCK = new CottageCheeseBlock(Block.Settings.of(Material.SOLID_ORGANIC, MapColor.OFF_WHITE).strength(1.0F).sounds(BlockSoundGroup.WART_BLOCK));
	public static final Item COTTAGE_CHEESE_BUCKET = new CottageCheeseBucketItem(BucketProvider.DEFAULT_PROVIDER.FilledBucketSettings().food(COTTAGE_CHEESE_FOOD_COMPONENT), BucketProvider.DEFAULT_PROVIDER);
	...
	public static final BlockContainer CHEESE_BLOCK = new BlockContainer(new Block(Block.Settings.of(Material.SOLID_ORGANIC, MapColor.YELLOW).strength(1.0F).sounds(BlockSoundGroup.WART_BLOCK)));
	...
	public static final OxidizableBlockContainer MEDIUM_WEIGHTED_PRESSURE_PLATE = new OxidizableBlockContainer(
			...
			(level) -> Block.Settings.of(Material.METAL, OxidationScale.getMapColor(level)).requiresTool().noCollision().strength(0.5F).sounds(BlockSoundGroup.WOOD)
	);
	//More Gold
	...
	public static final BlockContainer DARK_HEAVY_WEIGHTED_PRESSURE_PLATE = new BlockContainer(new HavenWeightedPressurePlateBlock(150, Block.Settings.of(Material.METAL).requiresTool().noCollision().strength(0.5F).sounds(BlockSoundGroup.WOOD)));
	...
	public static final BlockContainer CRUSHING_WEIGHTED_PRESSURE_PLATE = new BlockContainer(new HavenWeightedPressurePlateBlock(300, Block.Settings.of(Material.METAL).requiresTool().noCollision().strength(0.5F).sounds(BlockSoundGroup.WOOD)), ItemSettings().fireproof());

	//Soul Candles
	public static final DefaultParticleType SMALL_SOUL_FLAME_PARTICLE = FabricParticleTypes.simple(false);
	public static final BlockContainer SOUL_CANDLE = new BlockContainer(new CandleBlock(Block.Settings.of(Material.DECORATION, MapColor.BROWN).nonOpaque().strength(0.1F).sounds(BlockSoundGroup.CANDLE).luminance((state) -> (int)(state.get(CandleBlock.LIT) ? 2.5 * state.get(CandleBlock.CANDLES) : 0))));
	//Ender Candles
	public static final DefaultParticleType SMALL_ENDER_FLAME_PARTICLE = FabricParticleTypes.simple(false);
	public static final BlockContainer ENDER_CANDLE = new BlockContainer(new CandleBlock(Block.Settings.of(Material.DECORATION, MapColor.PALE_YELLOW).nonOpaque().strength(0.1F).sounds(BlockSoundGroup.CANDLE).luminance((state) -> (int)(state.get(CandleBlock.LIT) ? 2.75 * state.get(CandleBlock.CANDLES) : 0))));
	//Cakes
	public static final Block SOUL_CANDLE_CAKE = new HavenCandleCakeBlock(null, 2);
	public static final Block ENDER_CANDLE_CAKE = new HavenCandleCakeBlock(null, 3);
	...
	//Hedges
	public static final BlockContainer HEDGE_BLOCK = new BlockContainer(new Block(Block.Settings.of(Material.LEAVES).strength(0.2F).sounds(BlockSoundGroup.GRASS).nonOpaque()));
	...
	public static final Set<BaseMaterial> MATERIALS = Set.<BaseMaterial>of(
		...
		//Bamboo Wood
		BAMBOO_MATERIAL, DRIED_BAMBOO_MATERIAL, VANILLA_BAMBOO_MATERIAL,
		CHARRED_MATERIAL,
		//Wood Overrides
			MANGROVE_MATERIAL,
		//Reed Wood
		...
		//Misc
		BONE_MATERIAL, STUDDED_LEATHER_MATERIAL, FLEECE_MATERIAL, WOOD_MATERIAL
	);
	...
	public static final Set<BedContainer> BEDS = new HashSet<BedContainer>(Set.<BedContainer>of(
			RAINBOW_BED, MOSS_BED
	));
	...
	static {
		...
		HUGE_BLUE_MUSHROOM = HUGE_BLUE_MUSHROOM_FEATURE.configure(
			new HugeMushroomFeatureConfig(
				new SimpleBlockStateProvider(BLUE_MUSHROOM_MATERIAL.getBlock().getBlock().getDefaultState().with(MushroomBlock.DOWN, false)),
		...
		//Gilded Fungus
		GILDED_FUNGUS_CONFIG = new HugeFungusFeatureConfig(GILDED_NYLIUM.getBlock().getDefaultState(), GILDED_MATERIAL.getStem().getBlock().getDefaultState(), GILDED_MATERIAL.getWartBlock().getBlock().getDefaultState(), Blocks.SHROOMLIGHT.getDefaultState(), true);
		...
		PATCH_GILDED_ROOTS = Feature.RANDOM_PATCH.configure((new RandomPatchFeatureConfig.Builder(new SimpleBlockStateProvider(GILDED_ROOTS.getBlock().getDefaultState()), new SimpleBlockPlacer())).tries(64).cannotProject().build()).range(new RangeDecoratorConfig(UniformHeightProvider.create(YOffset.getBottom(), YOffset.getTop())));
		...
		UNLIT_LANTERNS.put(ENDER_LANTERN.getBlock(), UNLIT_ENDER_LANTERN);
		...
		for(BaseMaterial material : MATERIALS) {
			...
			if (material instanceof LanternProvider lantern) UNLIT_LANTERNS.put(lantern.getLantern().getBlock(), lantern.getUnlitLantern());
			if (material instanceof SoulLanternProvider soulLantern) UNLIT_LANTERNS.put(soulLantern.getSoulLantern().getBlock(), soulLantern.getUnlitSoulLantern());
			if (material instanceof EnderLanternProvider enderLantern) UNLIT_LANTERNS.put(enderLantern.getEnderLantern().getBlock(), enderLantern.getUnlitEnderLantern());
			if (material instanceof CampfireProvider campfire) CAMPFIRES.add(campfire.getCampfire().getBlock());
			if (material instanceof SoulCampfireProvider soulCampfire) CAMPFIRES.add(soulCampfire.getSoulCampfire().getBlock());
			if (material instanceof EnderCampfireProvider enderCampfire) CAMPFIRES.add(enderCampfire.getEnderCampfire().getBlock());
		}
		//Cauldrons
