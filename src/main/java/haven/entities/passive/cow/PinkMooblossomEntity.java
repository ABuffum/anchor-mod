...
public class PinkMooblossomEntity extends CowEntity implements Shearable {
	public PinkMooblossomEntity(EntityType<? extends PinkMooblossomEntity> entityType, World world) {
	...
	public static boolean canSpawn(EntityType<PinkMooblossomEntity> type, WorldAccess world, SpawnReason spawnReason, BlockPos pos, Random random) {
	...
	public void sheared(SoundCategory shearedSoundCategory) {
		...
		if (!this.world.isClient()) {
			...
			for(int i = 0; i < 5; ++i) {
				this.world.spawnEntity(new ItemEntity(this.world, this.getX(), this.getBodyY(1.0D), this.getZ(), new ItemStack(Items.PINK_TULIP)));
			}
		}
