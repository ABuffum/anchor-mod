...
public class HavenForgetAttackTargetTask <E extends MobEntity> extends Task<E> {
	...
	public HavenForgetAttackTargetTask(Predicate<LivingEntity> alternativePredicate, BiConsumer<E, LivingEntity> forgetCallback, boolean shouldForgetIfTargetUnreachable) {
	...
	public HavenForgetAttackTargetTask(Predicate<LivingEntity> alternativePredicate, BiConsumer<E, LivingEntity> forgetCallback) {
		this(alternativePredicate, forgetCallback, true);
	}

	public HavenForgetAttackTargetTask(Predicate<LivingEntity> alternativePredicate) {
		this(alternativePredicate, (mobEntity, livingEntity) -> {});
	}

	public HavenForgetAttackTargetTask(BiConsumer<E, LivingEntity> forgetCallback) {
		this((LivingEntity target) -> false, forgetCallback);
	}

	public HavenForgetAttackTargetTask() {
	...
	protected void run(ServerWorld serverWorld, E mobEntity, long l) {
		...
		if (this.shouldForgetIfTargetUnreachable && HavenForgetAttackTargetTask.cannotReachTarget(mobEntity)) {
			this.forgetAttackTarget(mobEntity);
			return;
		}
