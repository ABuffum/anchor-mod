...
import haven.rendering.features.cow.PinkMooblossomFlowerFeatureRenderer;
...
public class PinkMooblossomEntityRenderer extends MobEntityRenderer<PinkMooblossomEntity, CowEntityModel<PinkMooblossomEntity>> {
	private static final Identifier TEXTURE = ModBase.ID("textures/entity/cow/pink_mooblossom.png");
