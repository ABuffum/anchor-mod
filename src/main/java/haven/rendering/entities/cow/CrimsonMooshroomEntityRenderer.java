...
import haven.rendering.features.cow.CrimsonMooshroomMushroomFeatureRenderer;
...
public class CrimsonMooshroomEntityRenderer extends MobEntityRenderer<CrimsonMooshroomEntity, CowEntityModel<CrimsonMooshroomEntity>> {
	private static final Identifier TEXTURE = ModBase.ID("textures/entity/cow/crimson_mooshroom.png");
