...
import haven.rendering.features.BlueMooshroomMushroomFeatureRenderer;
...
public class BlueMooshroomEntityRenderer extends MobEntityRenderer<BlueMooshroomEntity, CowEntityModel<BlueMooshroomEntity>> {
	private static final Identifier TEXTURE = HavenMod.ID("textures/entity/cow/blue_mooshroom.png");
