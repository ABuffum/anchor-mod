...
import haven.mixins.client.rendering.ModelPartAccessor;
...
public class AnimationHelper {
	...
	public static boolean hasChild(ModelPart part, String child) {
		return ((ModelPartAccessor)(Object)part).getChildren().containsKey(child);
	}

	public static Optional<ModelPart> getChild(SinglePartEntityModel model, String name) {
