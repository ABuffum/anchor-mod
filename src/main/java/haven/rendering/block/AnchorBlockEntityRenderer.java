...
import haven.blocks.anchors.AnchorBlockEntity;
...
public class AnchorBlockEntityRenderer implements BlockEntityRenderer<AnchorBlockEntity> {
	...
	public AnchorBlockEntityRenderer(BlockEntityRendererFactory.Context ctx) {
		...
		ModelPart cube_r5 = new ModelPart(Arrays.asList(new ModelPart.Cuboid(0, 8, -1.0F, -4.5F, -1.0F, 2.0F, 8.0F, 2.0F, 0, 0, 0, false, 256, 256)), Collections.emptyMap());
		ModelPart cube_r6 = new ModelPart(Arrays.asList(new ModelPart.Cuboid(0, 21, -1.0F, -5.5F, -1.0F, 2.0F, 11.0F, 2.0F, 0, 0, 0, false, 256, 256)), Collections.emptyMap());
		ModelPart cube_r7 = new ModelPart(Arrays.asList(new ModelPart.Cuboid(8, 21, -1.3679F, -6.7998F, -1.0F, 2.0F, 11.0F, 2.0F, 0, 0, 0, false, 256, 256)), Collections.emptyMap());
		ModelPart cube_r8 = new ModelPart(Arrays.asList(new ModelPart.Cuboid(78, 89, -1.0795F, -15.8219F, -1.0F, 2.0F, 32.0F, 2.0F, 0, 0, 0, false, 256, 256)), Collections.emptyMap());
		ModelPart cube_r9 = new ModelPart(Arrays.asList(new ModelPart.Cuboid(86, 89, -1.0795F, -15.8219F, -1.0F, 2.0F, 32.0F, 2.0F, 0, 0, 0, false, 256, 256)), Collections.emptyMap());
		ModelPart cube_r10 = new ModelPart(Arrays.asList(new ModelPart.Cuboid(8, 8, -1.0F, -4.5F, -1.0F, 2.0F, 8.0F, 2.0F, 0, 0, 0, false, 256, 256)), Collections.emptyMap());
		ModelPart cube_r11 = new ModelPart(Arrays.asList(new ModelPart.Cuboid(0, 41, -1.0F, -5.5F, -1.0F, 2.0F, 11.0F, 2.0F, 0, 0, 0, false, 256, 256)), Collections.emptyMap());
		ModelPart cube_r12 = new ModelPart(Arrays.asList(new ModelPart.Cuboid(42, 41, -1.3679F, -6.7998F, -1.0F, 2.0F, 11.0F, 2.0F, 0, 0, 0, false, 256, 256)), Collections.emptyMap());
		ModelPart cube_r13 = new ModelPart(Arrays.asList(new ModelPart.Cuboid(32, 91, -1.0795F, -15.8219F, -1.0F, 2.0F, 32.0F, 2.0F, 0, 0, 0, false, 256, 256)), Collections.emptyMap());
		ModelPart cube_r14 = new ModelPart(Arrays.asList(new ModelPart.Cuboid(40, 93, -1.0795F, -15.8219F, -1.0F, 2.0F, 32.0F, 2.0F, 0, 0, 0, false, 256, 256)), Collections.emptyMap());
		ModelPart cube_r15 = new ModelPart(Arrays.asList(new ModelPart.Cuboid(54, 21, -1.0F, -4.5F, -1.0F, 2.0F, 8.0F, 2.0F, 0, 0, 0, false, 256, 256)), Collections.emptyMap());
		ModelPart cube_r16 = new ModelPart(Arrays.asList(new ModelPart.Cuboid(54, 0, -1.0F, -5.5F, -1.0F, 2.0F, 11.0F, 2.0F, 0, 0, 0, false, 256, 256)), Collections.emptyMap());
		ModelPart cube_r17 = new ModelPart(Arrays.asList(new ModelPart.Cuboid(24, 97, -1.3679F, -6.7998F, -1.0F, 2.0F, 11.0F, 2.0F, 0, 0, 0, false, 256, 256)), Collections.emptyMap());
		ModelPart cube_r18 = new ModelPart(Arrays.asList(new ModelPart.Cuboid(48, 93, -1.0795F, -15.8219F, -1.0F, 2.0F, 32.0F, 2.0F, 0, 0, 0, false, 256, 256)), Collections.emptyMap());
		ModelPart cube_r19 = new ModelPart(Arrays.asList(new ModelPart.Cuboid(56, 93, -1.0795F, -15.8219F, -1.0F, 2.0F, 32.0F, 2.0F, 0, 0, 0, false, 256, 256)), Collections.emptyMap());
		ModelPart cube_r20 = new ModelPart(Arrays.asList(new ModelPart.Cuboid(0, 61, -1.0F, -4.5F, -1.0F, 2.0F, 8.0F, 2.0F, 0, 0, 0, false, 256, 256)), Collections.emptyMap());
		ModelPart cube_r21 = new ModelPart(Arrays.asList(new ModelPart.Cuboid(24, 110, -1.0F, -5.5F, -1.0F, 2.0F, 11.0F, 2.0F, 0, 0, 0, false, 256, 256)), Collections.emptyMap());
		ModelPart cube_r22 = new ModelPart(Arrays.asList(new ModelPart.Cuboid(64, 93, -1.0795F, -15.8219F, -1.0F, 2.0F, 32.0F, 2.0F, 0, 0, 0, false, 256, 256)), Collections.emptyMap());
		ModelPart cube_r23 = new ModelPart(Arrays.asList(new ModelPart.Cuboid(102, 113, -1.3679F, -6.7998F, -1.0F, 2.0F, 11.0F, 2.0F, 0, 0, 0, false, 256, 256)), Collections.emptyMap());
		ModelPart cube_r24 = new ModelPart(Arrays.asList(new ModelPart.Cuboid(94, 89, -1.0795F, -15.8219F, -1.0F, 2.0F, 32.0F, 2.0F, 0, 0, 0, false, 256, 256)), Collections.emptyMap());
		ModelPart cube_r25 = new ModelPart(Arrays.asList(new ModelPart.Cuboid(36, 64, 6.0F, -38.0F, -8.0F, 2.0F, 5.0F, 2.0F, 0, 0, 0, false, 256, 256)), Collections.emptyMap());
		ModelPart cube_r26 = new ModelPart(Arrays.asList(new ModelPart.Cuboid(44, 66, 6.0F, -38.0F, -8.0F, 2.0F, 5.0F, 2.0F, 0, 0, 0, false, 256, 256)), Collections.emptyMap());
		ModelPart cube_r27 = new ModelPart(Arrays.asList(new ModelPart.Cuboid(78, 68, 6.0F, -38.0F, -8.0F, 2.0F, 5.0F, 2.0F, 0, 0, 0, false, 256, 256)), Collections.emptyMap());
		ModelPart cube_r28 = new ModelPart(Arrays.asList(new ModelPart.Cuboid(104, 54, 4.0F, -33.0F, -9.0F, 5.0F, 3.0F, 5.0F, 0, 0, 0, false, 256, 256)), Collections.emptyMap());
		ModelPart cube_r29 = new ModelPart(Arrays.asList(new ModelPart.Cuboid(105, 11, 4.0F, -33.0F, -9.0F, 5.0F, 3.0F, 5.0F, 0, 0, 0, false, 256, 256)), Collections.emptyMap());
		ModelPart cube_r30 = new ModelPart(Arrays.asList(new ModelPart.Cuboid(106, 70, 4.0F, -33.0F, -9.0F, 5.0F, 3.0F, 5.0F, 0, 0, 0, false, 256, 256)), Collections.emptyMap());
