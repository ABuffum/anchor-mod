...
public class RedPandaEntityModel extends EntityModel<RedPandaEntity> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData frontrightleg = modelPartData.addChild("frontrightleg", ModelPartBuilder.create().uv(34, 0).cuboid(-1.5F, 0.0F, -1.5F, 3.0F, 6.0F, 3.0F), ModelTransform.pivot(-2.5F, 18.0F, -4.5F));

		ModelPartData frontleftleg = modelPartData.addChild("frontleftleg", ModelPartBuilder.create().uv(0, 14).cuboid(3.5F, 0.0F, -1.5F, 3.0F, 6.0F, 3.0F), ModelTransform.pivot(-2.5F, 18.0F, -4.5F));

		ModelPartData backrightleg = modelPartData.addChild("backrightleg", ModelPartBuilder.create().uv(31, 11).cuboid(-1.5F, 0.0F, -1.5F, 3.0F, 6.0F, 3.0F), ModelTransform.pivot(-2.5F, 18.0F, 3.5F));

		ModelPartData backleftleg = modelPartData.addChild("backleftleg", ModelPartBuilder.create().uv(48, 0).cuboid(-1.5F, 0.0F, -1.5F, 3.0F, 6.0F, 3.0F), ModelTransform.pivot(2.5F, 18.0F, 3.5F));
