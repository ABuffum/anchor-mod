...
public class CalciteMaterial extends BaseMaterial implements
	...
	public CalciteMaterial() {
		super("calcite", false);
		smooth = new BlockContainer(new Block(AbstractBlock.Settings.copy(Blocks.CALCITE)));
		...
		bricks = new BlockContainer(new Block(AbstractBlock.Settings.copy(Blocks.CALCITE)));
