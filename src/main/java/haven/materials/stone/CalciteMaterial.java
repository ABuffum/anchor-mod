...
public class CalciteMaterial extends BaseMaterial implements
	...
	public CalciteMaterial() {
		super("calcite", false);
		slab = new BlockContainer(new ModSlabBlock(Blocks.CALCITE), ItemSettings());
		stairs = new BlockContainer(new ModStairsBlock(Blocks.CALCITE), ItemSettings());
		wall = new BlockContainer(new ModWallBlock(Blocks.CALCITE), ItemSettings());
