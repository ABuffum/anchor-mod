...
public class NetheriteMaterial extends BaseMaterial implements
	...
	public NetheriteMaterial() {
		...
		torch = MakeTorch(14, BlockSoundGroup.NETHERITE, HavenMod.NETHERITE_FLAME_PARTICLE);
		ender_torch = MakeTorch(10, BlockSoundGroup.NETHERITE, HavenMod.ENDER_FIRE_FLAME_PARTICLE);
		soul_torch = MakeTorch(10, BlockSoundGroup.NETHERITE, ParticleTypes.SOUL_FIRE_FLAME);
