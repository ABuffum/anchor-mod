...
public class GoldMaterial extends BaseMaterial implements
	...
	public GoldMaterial() {
		super("gold", false);
		torch = MakeTorch(ModBase.LUMINANCE_14, BlockSoundGroup.METAL, ModBase.GOLD_FLAME_PARTICLE);
		...
		wall = new BlockContainer(new ModWallBlock(Blocks.GOLD_BLOCK), ItemSettings());
		bricks = new BlockContainer(new Block(AbstractBlock.Settings.copy(Blocks.GOLD_BLOCK)), ItemSettings());
