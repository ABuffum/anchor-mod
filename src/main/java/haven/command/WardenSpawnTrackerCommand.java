...
import haven.util.CommandUtils;
		...
		dispatcher.register(CommandManager.literal("warden_spawn_tracker")
				...
				.then(CommandManager.literal("clear").executes(context ->
						WardenSpawnTrackerCommand.clearTracker(
								context.getSource(),
								ImmutableList.of(CommandUtils.getPlayerOrThrow(context.getSource())))))
				.then(CommandManager.literal("set")
						.then((ArgumentBuilder<ServerCommandSource, ?>)CommandManager.argument("warning_level", IntegerArgumentType.integer(0, 4))
