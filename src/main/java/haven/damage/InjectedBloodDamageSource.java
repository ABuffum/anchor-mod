...
public class InjectedBloodDamageSource extends EntityDamageSource {
	...
	public Text getDeathMessage(LivingEntity entity) {
		...
		return livingEntity != null
				? new TranslatableText(string2, new Object[]{entity.getDisplayName(), livingEntity.getDisplayName(), Text.of(bloodType.getName())})
				: new TranslatableText(string, new Object[]{entity.getDisplayName(), Text.of(bloodType.getName())});
	}
	@Override
