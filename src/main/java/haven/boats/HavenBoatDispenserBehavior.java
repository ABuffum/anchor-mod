...
public class HavenBoatDispenserBehavior extends ItemDispenserBehavior {
	private final ItemDispenserBehavior itemDispenser = new ItemDispenserBehavior();
	private final HavenBoatType boatType;

	public HavenBoatDispenserBehavior(HavenBoatType type) {
		this.boatType = type;
	}
	...
	public ItemStack dispenseSilently(BlockPointer pointer, ItemStack stack) {
		...
		HavenBoatEntity boatEntity = new HavenBoatEntity(world, d, e + i, f);
