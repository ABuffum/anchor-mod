...
public class PointedDripstoneUtil {
	...
	public record Emitter(Entity sourceEntity, BlockState affectedState) {
		public static Emitter of(Entity sourceEntity) {
			return new Emitter(sourceEntity, null);
		}

		public static Emitter of(BlockState affectedState) {
			return new Emitter(null, affectedState);
		}

		public static Emitter of(Entity sourceEntity, BlockState affectedState) {
