...
import fun.mousewich.gen.feature.CherrySaplingGenerator;
...
public class CherrySaplingBlock extends PlantBlock implements Fertilizable {
	public static final IntProperty STAGE = Properties.STAGE;
	protected static final VoxelShape SHAPE = Block.createCuboidShape(2.0, 0.0, 2.0, 14.0, 12.0, 14.0);
	private final CherrySaplingGenerator generator;

	public CherrySaplingBlock(CherrySaplingGenerator generator, AbstractBlock.Settings settings) {
		super(settings);
