...
public class ModBlockTags {
	public static final Tag.Identified<Block> TERRACOTTA = createMinecraftTag("terracotta");
	...
	public static final Tag.Identified<Block> FROGS_SPAWNABLE_ON = createMinecraftTag("frogs_spawnable_on");
	public static final Tag.Identified<Block> MANGROVE_LOGS = createMinecraftTag("mangrove_logs");
	...
	public static final Tag.Identified<Block> TRAIL_RUINS_REPLACEABLE = createMinecraftTag("trail_ruins_replaceable");
	public static final Tag.Identified<Block> VIBRATION_RESONATORS = createMinecraftTag("vibration_resonators");
	...
	public static final Tag.Identified<Block> CHARRED_LOGS = createTag("charred_logs");
	public static final Tag.Identified<Block> CHISELED_BOOKSHELVES = createTag("chiseled_bookshelves");
	...
	public static final Tag.Identified<Block> LOG_SLABS = createTag("log_slabs");
	public static final Tag.Identified<Block> PISTON_IMMOVABLE = createTag("piston_immovable");
