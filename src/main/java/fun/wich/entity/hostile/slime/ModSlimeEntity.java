...
import fun.wich.entity.ai.goal.slime.FaceTowardTargetGoal;
import fun.wich.entity.ai.goal.slime.MoveGoal;
import fun.wich.entity.ai.goal.slime.RandomLookGoal;
import fun.wich.entity.ai.goal.slime.SwimmingGoal;
