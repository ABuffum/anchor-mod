...
public class HavenMod {
	...
	public static final StatusEffect MARKED_EFFECT = new ModStatusEffect(StatusEffectType.NEUTRAL,0xFF00FF).milkImmune();
	//</editor-fold>
