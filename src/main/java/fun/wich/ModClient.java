...
import fun.wich.client.render.entity.renderer.ModBoatEntityRenderer;
...
import fun.wich.mixins.client.render.item.ModelPredicateProviderRegistryInvoker;
...
public class ModClient implements ClientModInitializer {
	...
	public void onInitializeClient() {
		...
		//Warden
		EntityModelLayerRegistry.registerModelLayer(ModEntityModelLayers.WARDEN, fun.wich.client.render.entity.model.WardenEntityModel::getTexturedModelData);
		...
		//Hedgehog Entity
		EntityModelLayerRegistry.registerModelLayer(ModEntityModelLayers.HEDGEHOG, fun.wich.client.render.entity.model.HedgehogEntityModel::getTexturedModelData);
		EntityRendererRegistry.register(HEDGEHOG_ENTITY, fun.wich.client.render.entity.renderer.HedgehogEntityRenderer::new);
		//Raccoons
		...
		EntityRendererRegistry.register(MELON_GOLEM_ENTITY, fun.wich.client.render.entity.renderer.MelonGolemEntityRenderer::new);
		//Chicken Variants
		...
		//Tropical Slime
		EntityModelLayerRegistry.registerModelLayer(ModEntityModelLayers.TROPICAL_SLIME, TropicalSlimeEntityModel::getInnerTexturedModelData);
		...
		//Generic 1x1
		ScreenRegistry.register(GENERIC_1X1_SCREEN_HANDLER, Generic1x1ContainerScreen::new);
		//Woodcutter
		ScreenRegistry.register(WOODCUTTER_SCREEN_HANDLER, WoodcutterScreen::new);
		//Trimming Table
		ScreenRegistry.register(TRIMMING_SCREEN_HANDLER, TrimmingScreen::new);
		//Projectiles
		...
		ModelPredicateProviderRegistryInvoker.Register(GOAT_HORN, TOOTING, MODEL_PREDICATE_PROVIDER);
		ModelPredicateProviderRegistryInvoker.Register(WIND_HORN, TOOTING, MODEL_PREDICATE_PROVIDER);
		//Javelin
		...
		ModelPredicateProviderRegistryInvoker.Register(JAVELIN, new Identifier("throwing"), MODEL_PREDICATE_PROVIDER);
		//Custom Tridents
		EntityRendererRegistry.register(AMETHYST_TRIDENT_ENTITY, JavelinEntityRenderer::new);
		ModelPredicateProviderRegistryInvoker.Register(AMETHYST_TRIDENT, new Identifier("throwing"), ModClient.MODEL_PREDICATE_PROVIDER);
		//Powder Kegs
